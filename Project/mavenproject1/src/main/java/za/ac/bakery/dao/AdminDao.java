...
import za.ac.bakery.Inteface.AdminInterface;
...
public class AdminDao implements AdminInterface {
    ...
    public AdminDao(String url, String username, String password) {
    ...
    public static void main(String[] args) {
        ...
        AdminDao dao = new AdminDao("jdbc:mysql://localhost:3306/bakery-systemdb", "root", "root");
